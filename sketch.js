...
function setup(){
  ...
  ciclistaPrincipal.setCollider("circle",0,0,600);
...
function draw() {
  ...
  text("Highscore: "+ highscore,750,30);
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(CGRosa.isTouching(ciclistaPrincipal)){
    ...
    text("Aperte pra cima para reiniciar!",525,200);
...
function ciclistaRosa(){
        ...
        jogador1.scale =0.06;
        jogador1.setCollider("circle",0,0,600);
...
function ciclistaAmarelo(){
        ...
        jogador2.scale =0.06;
        jogador2.setCollider("circle",0,0,600);
...
function ciclistaVermelho(){
        ...
        jogador3.scale =0.06;
        jogador3.setCollider("circle",0,0,600);
...
function reset() {
  ...
  switch (destroyer) {
    case 1: CGRosa.destroyEach(); break;
    case 2: CGAmarelo.destroyEach(); break;
    case 3: CGVermelho.destroyEach(); break;
    default: break;
  }
}
